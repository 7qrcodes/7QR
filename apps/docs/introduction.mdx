---
title: Introduction
"og:title": "Getting Started with 7QR - Documentation"
description: "7QR is the open-source link management infrastructure for modern marketing teams."
---

<Frame>
  <img
    className="rounded-lg border border-gray-100"
    src="https://assets.7qr.codes/thumbnail.png"
    alt="7QR Thumbnail"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Create a free account" icon="code" href="https://app.7qr.codes">
