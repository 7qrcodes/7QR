    ...
    return [
      {
        ...
        destination: "https://app.7qr.codes",
        permanent: true,
        statusCode: 301,
      },
      {
        ...
        destination: "https://app.7qr.codes/:path*",
        permanent: true,
        statusCode: 301,
      },
        ...
        (segment) => (
          {
            ...
            destination: `https://7qr.codes/${segment}`,
            permanent: true,
            statusCode: 301,
          },
          {
            ...
            destination: `https://7qr.codes/${segment}/:path*`,
            permanent: true,
            statusCode: 301,
          }
        ),
      ),
      {
        ...
        destination: "https://7qr.codes/tools/metatags",
        permanent: true,
        statusCode: 301,
      },
      {
      ...
      },
      {
        ...
        destination: "https://preview.7qr.codes",
        permanent: true,
        statusCode: 301,
      },
      {
        ...
        destination: "https://admin.7qr.codes",
        permanent: true,
        statusCode: 301,
      },
    ];
